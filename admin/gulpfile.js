...
gulp.task('sass', function(){
    return gulp.src('./server/public/scss/*.scss')
        .pipe(sass().on('error', sass.logError))
        .pipe(gulp.dest('./server/public/css'));
});

gulp.task('sass:watch', function () {
    gulp.watch('./server/public/scss/*.scss', ['sass']);
});
...
gulp.task('dev', function(){
    gulp.src('./dist/**').pipe(gulp.dest('f:/node-weixin/dist'));
    gulp.src('./node_modules/**').pipe(gulp.dest('f:/node-weixin/node_modules'));
    gulp.src('./oauth/**').pipe(gulp.dest('f:/node-weixin/oauth'));
    gulp.src('./package.json').pipe(gulp.dest('f:/node-weixin'));
});
